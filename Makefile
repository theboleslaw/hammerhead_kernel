...
KERNELFLAGS	= -munaligned-access -fgcse-sm -Ofast -fsingle-precision-constant -fforce-addr -fsched-spec-load -mtune=cortex-a15 -mcpu=cortex-a15 -marm -mfpu=neon-vfpv4 -mvectorize-with-neon-quad -funroll-loops
