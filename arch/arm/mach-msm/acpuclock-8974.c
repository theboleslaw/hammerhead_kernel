...
static struct l2_level l2_freq_tbl_v2[] __initdata = {
	[0]  = { {  300000, PLL_0, 0,   0 }, LVL_LOW,   900000, 0 },
	[1]  = { {  345600, HFPLL, 2,  36 }, LVL_LOW,   900000, 1 },
	[2]  = { {  422400, HFPLL, 2,  44 }, LVL_LOW,   900000, 2 },
	[3]  = { {  499200, HFPLL, 2,  52 }, LVL_LOW,   900000, 3 },
	[4]  = { {  576000, HFPLL, 1,  30 }, LVL_LOW,   900000, 4 },
	[5]  = { {  652800, HFPLL, 1,  34 }, LVL_NOM,   900000, 4 },
	[6]  = { {  729600, HFPLL, 1,  38 }, LVL_NOM,   900000, 4 },
	[7]  = { {  806400, HFPLL, 1,  42 }, LVL_NOM,   900000, 4 },
	[8]  = { {  883200, HFPLL, 1,  46 }, LVL_NOM,   900000, 5 },
	[9]  = { {  960000, HFPLL, 1,  50 }, LVL_NOM,   900000, 5 },
	[10] = { { 1036800, HFPLL, 1,  54 }, LVL_NOM,   900000, 5 },
	[11] = { { 1113600, HFPLL, 1,  58 }, LVL_HIGH, 1000000, 6 },
	[12] = { { 1190400, HFPLL, 1,  62 }, LVL_HIGH, 1000000, 6 },
	[13] = { { 1267200, HFPLL, 1,  66 }, LVL_HIGH, 1000000, 6 },
	[14] = { { 1344000, HFPLL, 1,  70 }, LVL_HIGH, 1000000, 6 },
	[15] = { { 1420800, HFPLL, 1,  74 }, LVL_HIGH, 1000000, 6 },
	[16] = { { 1497600, HFPLL, 1,  78 }, LVL_HIGH, 1000000, 6 },
	[17] = { { 1574400, HFPLL, 1,  82 }, LVL_HIGH, 1000000, 7 },
	[18] = { { 1651200, HFPLL, 1,  86 }, LVL_HIGH, 1000000, 7 },
	[19] = { { 1728000, HFPLL, 1,  90 }, LVL_HIGH, 1000000, 8 },
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs0[] __initdata = {
	...
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(20),  915000, 333 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(20),  950000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(20),  965000, 430 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(20),  995000, 482 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(21), 1040000, 565 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(22), 1100000, 691 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs1[] __initdata = {
	...
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(20),  895000, 333 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(20),  930000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(20),  945000, 430 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(20),  975000, 482 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(21), 1020000, 565 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(22), 1075000, 691 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs2[] __initdata = {
	...
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(20),  875000, 333 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(20),  910000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(20),  925000, 430 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(20),  955000, 482 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(21),  995000, 565 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(22), 1050000, 691 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs3[] __initdata = {
	...
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(20),  860000, 333 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(20),  895000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(20),  910000, 430 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(20),  935000, 482 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(21),  970000, 565 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(22), 1025000, 691 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs4[] __initdata = {
	...
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(20),  850000, 333 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(20),  880000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(20),  895000, 430 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(20),  920000, 482 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(21),  950000, 565 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(22), 1000000, 691 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs5[] __initdata = {
	...
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(20),  840000, 333 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(20),  870000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(20),  880000, 430 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(20),  900000, 482 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(21),  930000, 565 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(22),  975000, 691 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs6[] __initdata = {
	...
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(20),  830000, 333 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(20),  860000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(20),  870000, 430 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(20),  885000, 482 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(21),  915000, 565 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(22),  950000, 691 },
	{ 0, { 0 } }
};
